...
namespace Student_Record_System {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentsRow AddStudentsRow(string Name, int Grade, string Subject, string Marks) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public string Marks {
                get {
                    return ((string)(this[this.tableStudents.MarksColumn]));
                }
                set {
...
namespace Student_Record_System.DataSetTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Student_Record_System.Properties.Settings.Default.ConnectionString;
        }
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([Id] = @Original_Id) AND ([Name] = @Original" +
                "_Name) AND ([Grade] = @Original_Grade) AND ([Subject] = @Original_Subject) AND (" +
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Name], [Grade], [Subject], [Marks]) VALUES (@Name," +
                " @Grade, @Subject, @Marks);\r\nSELECT Id, Name, Grade, Subject, Marks FROM Student" +
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [Name] = @Name, [Grade] = @Grade, [Subject] = @Subject, [Marks] = @Marks WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Grade] = @Original_Grade) AND ([Subject] = @Original_Subject) AND ([Marks] = @Original_Marks));
SELECT Id, Name, Grade, Subject, Marks FROM Students WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Name, Grade, Subject, Marks FROM dbo.Students";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Name, Grade, Subject, Marks FROM dbo.Students";
        ...
        public virtual int FillBy(DataSet.StudentsDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Grade, string Original_Subject, string Original_Marks) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Name, int Grade, string Subject, string Marks) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Grade, string Subject, string Marks, int Original_Id, string Original_Name, int Original_Grade, string Original_Subject, string Original_Marks, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            if ((Original_Marks == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_Marks));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Grade, string Subject, string Marks, int Original_Id, string Original_Name, int Original_Grade, string Original_Subject, string Original_Marks) {
            return this.Update(Name, Grade, Subject, Marks, Original_Id, Original_Name, Original_Grade, Original_Subject, Original_Marks, Original_Id);
        }
    }
